...
describe("DayPickerKeyboardShortcuts", () => {
  describe("#UNSAFE_componentWillReceiveProps", () => {
    describe("when the phrases have been updated", () => {
      const prevProps = {
        phrases: { enterKey: "foo", escape: "bar", questionMark: "baz" },
      };
      const newProps = {
        phrases: { enterKey: "bleep", escape: "blah", questionMark: "boop" },
      };

      it("updates the keyboardShortcuts", () => {
        const wrapper = shallow(
          <DayPickerKeyboardShortcuts {...prevProps} />
        ).dive();
  ...
  describe("#componentDidUpdate", () => {
    it("focuses the hideKeyboardShortcutsButton", () => {
      ...
      wrapper
        .instance()
        .setHideKeyboardShortcutsButtonRef({ focus: hideButtonFocusStub });
  ...
  describe("#onShowKeyboardShortcutsButtonClick", () => {
    ...
    beforeEach(() => {
      ...
      wrapper
        .instance()
        .setShowKeyboardShortcutsButtonRef({ focus: showButtonFocusStub });
  ...
  describe("#render", () => {
    describe("#showKeyboardShortcutsButton", () => {
      ...
      describe("when showKeyboardShortcutsPanel is true", () => {
        it("sets the aria-label to the hideKeyboardShortcutsPanel phrase", () => {
          const hideKeyboardShortcutsPanel =
            "Test HIDE Keyboard Shortcuts Panel phrase";
          const phrases = {
          ...
          expect(wrapper.children("button").prop("aria-label")).to.equal(
            hideKeyboardShortcutsPanel
          );
        });
      });
      ...
      describe("when showKeyboardShortcutsPanel is false", () => {
        it("sets the aria-label to the showKeyboardShortcutsPanel phrase", () => {
          const showKeyboardShortcutsPanel =
            "Test SHOW Keyboard Shortcuts Panel phrase";
          const phrases = {
            ...DayPickerKeyboardShortcutsPhrases,
            showKeyboardShortcutsPanel,
          };
      ...
      describe("renderKeyboardShortcutsButton", () => {
        it("renders the provided button", () => {
          ...
          const wrapper = shallow(
            <DayPickerKeyboardShortcuts {...props} />
          ).dive();
        ...
        it("renders the provided keyboard shortcuts panel", () => {
          const props = {
            renderKeyboardShortcutsPanel: () => (
              <div>Keyboard shortcuts here!</div>
            ),
    ...
    describe("#DayPickerKeyboardShortcuts_panel", () => {
      ...
      it("sets props.phrases.keyboardShortcuts as the aria-labelledby value", () => {
        ...
        const ariaLabelledbyId = wrapper
          .find('div[role="dialog"]')
          .prop("aria-labelledby");
        expect(wrapper.find(`div#${ariaLabelledbyId}`).text()).to.equal(
          keyboardShortcuts
        );
      });
      ...
      it("sets the unordered list of keyboard shortcuts as the aria-describedby", () => {
        ...
        const ariaDescribedbyId = wrapper
          .find('div[role="dialog"]')
    ...
    describe("Close button", () => {
      it("is rendered", () => {
        ...
        expect(
          wrapper.find('div[role="dialog"]').children("button")
        ).to.have.lengthOf(1);
      });
      ...
      it("sets the aria-label to the hideKeyboardShortcutsPanel phrase", () => {
        ...
        expect(
          wrapper
            ...
            .children("button")
            .prop("aria-label")
        ).to.equal(hideKeyboardShortcutsPanel);
      });
    });
