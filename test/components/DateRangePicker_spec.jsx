...
describe('DateRangePicker', () => {
  describe('#render()', () => {
    ...
    it('renders .DateRangePicker__picker class', () => {
      const wrapper = shallow(<DateRangePicker selectedInput={START_DATE} />);
    ...
    describe('props.orientation === VERTICAL_ORIENTATION', () => {
      it('renders .DateRangePicker__picker--vertical class', () => {
        const wrapper = shallow(
          <DateRangePicker orientation={VERTICAL_ORIENTATION} selectedInput={START_DATE} />,
        );
    ...
    describe('props.orientation === HORIZONTAL_ORIENTATION', () => {
      it('renders .DateRangePicker__picker--horizontal class', () => {
        const wrapper = shallow(
          <DateRangePicker orientation={HORIZONTAL_ORIENTATION} selectedInput={START_DATE} />,
        );
    ...
    describe('props.anchorDirection === ANCHOR_LEFT', () => {
      it('renders .DateRangePicker__picker--direction-left class', () => {
        const wrapper = shallow(
          <DateRangePicker anchorDirection={ANCHOR_LEFT} selectedInput={START_DATE} />,
        );
    ...
    describe('props.orientation === ANCHOR_RIGHT', () => {
      it('renders .DateRangePicker__picker--direction-right class', () => {
        const wrapper = shallow(
          <DateRangePicker anchorDirection={ANCHOR_RIGHT} selectedInput={START_DATE} />,
        );
    ...
    describe('props.withPortal is truthy', () => {
      it('renders .DateRangePicker__picker--portal class', () => {
        const wrapper = shallow(<DateRangePicker withPortal selectedInput={START_DATE} />);
      ...
      describe('<Portal />', () => {
        ...
        it('is not rendered if props.selectedInput === null', () => {
          const wrapper =
            shallow(<DateRangePicker selectedInput={null} withPortal />);
          expect(wrapper.find(Portal)).to.have.length(0);
        });

        it('isOpened prop is true if props.selectedInput !== null', () => {
          const wrapper = shallow(<DateRangePicker withPortal selectedInput={START_DATE} />);
    ...
    describe('props.withFullScreenPortal is truthy', () => {
      it('renders .DateRangePicker__picker--portal class', () => {
        const wrapper =
          shallow(<DateRangePicker withFullScreenPortal selectedInput={START_DATE} />);
        expect(wrapper.find('.DateRangePicker__picker--portal')).to.have.length(1);
      });
      ...
      describe('<Portal />', () => {
        it('is rendered', () => {
          const wrapper = shallow(
            <DateRangePicker withFullScreenPortal selectedInput={START_DATE} />,
          );
          expect(wrapper.find(Portal)).to.have.length(1);
        });
        ...
        it('is not rendered if props.selectedInput === null', () => {
          const wrapper =
            shallow(<DateRangePicker selectedInput={null} withFullScreenPortal />);
          expect(wrapper.find(Portal)).to.have.length(0);
        });
    ...
    describe('props.selectedInput', () => {
      it('renders <DayPickerRangeController> if props.selectedInput != null', () => {
        const wrapper = shallow(<DateRangePicker selectedInput={START_DATE} />);
        expect(wrapper.find(DayPickerRangeController)).to.have.length(1);
      });

      it('does not render <DayPickerRangeController> if props.selectedInput = null', () => {
        const wrapper = shallow(<DateRangePicker selectedInput={null} />);
        expect(wrapper.find(DayPickerRangeController)).to.have.length(0);
      });
    });
  });
  ...
  describe('#onOutsideClick', () => {
    it('does not call props.onSelectedInputChange if props.selectedInput = null', () => {
      const onSelectedInputChangeStub = sinon.stub();
      const wrapper = shallow(
        <DateRangePicker selectedInput={null} onSelectedInputChange={onSelectedInputChangeStub} />,
      );
      wrapper.instance().onOutsideClick();
      expect(onSelectedInputChangeStub.callCount).to.equal(0);
    });

    it('calls props.onSelectedInputChange if props.selectedInput != null', () => {
      const onSelectedInputChangeStub = sinon.stub();
      const wrapper = shallow(
        <DateRangePicker
  ...
  describe('initialVisibleMonth', () => {
    describe('initialVisibleMonth is passed in', () => {
      it('DayPickerRangeController.props.initialVisibleMonth is equal to initialVisibleMonth', () => {
        ...
        const wrapper = shallow(
          <DateRangePicker selectedInput={START_DATE} initialVisibleMonth={initialVisibleMonth} />,
        );
    ...
    describe('initialVisibleMonth is not passed in', () => {
      it('DayPickerRangeController.props.initialVisibleMonth evaluates to startDate', () => {
        ...
        const wrapper =
          shallow(<DateRangePicker selectedInput={START_DATE} startDate={startDate} />);
        const dayPicker = wrapper.find(DayPickerRangeController);
      ...
      it('DayPickerRangeController.props.initialVisibleMonth evaluates to endDate if !startDate', () => {
        ...
        const wrapper =
          shallow(<DateRangePicker selectedInput={START_DATE} endDate={endDate} />);
        const dayPicker = wrapper.find(DayPickerRangeController);
      ...
      it('DayPickerRangeController.props.initialVisibleMonth evaluates to today if !startDate && !endDate', () => {
        const today = moment();
        const wrapper =
          shallow(<DateRangePicker selectedInput={START_DATE} />);
        const dayPicker = wrapper.find(DayPickerRangeController);
