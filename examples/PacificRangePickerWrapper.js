...
import PacificRangeController from '../src/components/PacificRangeController';
...
class PacificRangePickerWrapper extends React.Component {
  constructor(props) {
    super(props);
...
PacificRangePickerWrapper.propTypes = propTypes;
PacificRangePickerWrapper.defaultProps = defaultProps;

export default PacificRangePickerWrapper;
