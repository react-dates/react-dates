...
var DateRangePickerInputController = /*#__PURE__*/function (_ref) {
  ...
  _proto.onEndDateChange = function onEndDateChange(endDateString) {
    ...
    var isEndDateValid = endDate && !isOutsideRange(endDate) && !isDayBlocked(endDate) && !(startDate && isBeforeDay(endDate, addDays(startDate, minimumNights)));
  ...
  _proto.onStartDateChange = function onStartDateChange(startDateString) {
    ...
    var isEndDateBeforeStartDate = isBeforeDay(endDate, addDays(startDate, minimumNights));
