...
const propTypes = forbidExtraProps({
  ...
  firstDateOfMonthStyles: DayStyleShape,
  lastDateOfMonthStyles: DayStyleShape,
...
class CustomizableCalendarDay extends React.PureComponent {
  ...
  render() {
    const {
      ...
      firstDateOfMonthStyles: firstDateOfMonthStylesWithHover,
      lastDateOfMonthStyles: lastDateOfMonthStylesWithHover,
    ...
    return (
      <td
        {...css(
          ...
          modifiers.has('first-date-of-month') && getStyles(firstDateOfMonthStylesWithHover, isHovered),
          modifiers.has('last-date-of-month') && getStyles(lastDateOfMonthStylesWithHover, isHovered),
