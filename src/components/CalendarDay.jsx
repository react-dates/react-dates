    ...
    return (
      <td
        {...css(
          ...
          modifiers.has('first-date-of-month') && styles.CalendarDay__firstDateOfMonth,
          modifiers.has('last-date-of-month') && styles.CalendarDay__lastDateOfMonth,
...
export default withStyles(({ reactDates: { color, font } }) => ({
  ...
  CalendarDay__firstDateOfMonth: {},
  CalendarDay__lastDateOfMonth: {},
