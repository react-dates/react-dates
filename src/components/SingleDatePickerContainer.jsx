...
class SingleDatePickerContainer extends React.Component {
  constructor(props) {
    super(props);
...
SingleDatePickerContainer.propTypes = propTypes;
SingleDatePickerContainer.defaultProps = defaultProps;

export { SingleDatePickerContainer as PureSingleDatePickerContainer };
