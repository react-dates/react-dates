...
export default class DayPicker extends React.Component {
  static applyTransformStyles(el, transform, opacity = '') {
    ...
    Object.assign(el.style, transformStyles);
  }
  ...
  getMonthHeight(el) {
    ...
    return (
      DayPicker.calculateDimension(caption, 'height', true, true) +
      DayPicker.calculateDimension(grid, 'height') + 1
    );
  }
  ...
  initializeDayPickerWidth() {
    this.dayPickerWidth = DayPicker.calculateDimension(
  ...
  updateStateAfterMonthTransition() {
    ...
    DayPicker.applyTransformStyles(
      this.calendarMonthGrid.getDOMNode().querySelector('.CalendarMonth'),
      'none'
    );
  ...
  adjustDayPickerHeight() {
    ...
    if (newMonthHeight !== DayPicker.calculateDimension(this.transitionContainer, 'height')) {
