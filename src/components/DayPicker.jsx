...
class DayPicker extends React.PureComponent {
  ...
  renderWeekHeader(index) {
    ...
    let left = index * calendarMonthWidth + dayPickerHorizontalPadding * (index + 2);

    if (index === 0) {
      left = index * calendarMonthWidth + dayPickerHorizontalPadding;
    }
  ...
  render() {
    ...
    const { reactDates: { spacing: { dayPickerHorizontalPadding } } } = theme;
    const { reactDates: { spacing: { dayPickerInnerPadding } } } = theme;
    ...
    const wrapperHorizontalWidth = (calendarMonthWidth * numberOfMonths)
      + (2 * dayPickerHorizontalPadding) + (2 * dayPickerInnerPadding);
