...
export default class DayPickerInstrumented extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hoverDate: null,
...
DayPickerInstrumented.propTypes = propTypes;
DayPickerInstrumented.defaultProps = defaultProps;
