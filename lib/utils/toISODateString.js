...
function toISODateString(date, currentFormat) {
  if (Object.prototype.toString.call(date) === '[object Date]') {
    if ((0, _isValid["default"])(date)) {
      return (0, _format["default"])(date, _constants.ISO_FORMAT);
    }
  }
  ...
  if (typeof date === 'string') {
    if (currentFormat) {
      ...
      if ((0, _isValid["default"])(newDate)) {
        return (0, _format["default"])(newDate, _constants.ISO_FORMAT);
      }
    } else {
      var _newDate;
      ...
      if ((0, _isValid["default"])(_newDate)) {
        return (0, _format["default"])(_newDate, _constants.ISO_FORMAT);
      }
