...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)(_objectSpread(_objectSpread({}, _reactWithStyles.withStylesPropTypes), {}, {
  ...
  focusedDate: _propTypes["default"].object,
...
var defaultProps = {
  month: (0, _addHours["default"])((0, _startOfDay["default"])(new Date()), 12),
...
var CalendarMonth = /*#__PURE__*/function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    var localeData = (0, _getLocale["default"])(props.locale);
    _this.state = {
      weeks: (0, _getCalendarMonthWeeks["default"])(props.month, props.enableOutsideDays, props.firstDayOfWeek === null ? localeData.options.weekStartsOn : props.firstDayOfWeek, // 0 : props.firstDayOfWeek,
      props.locale)
    };
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (!(0, _isEqual["default"])(month, prevMonth) || enableOutsideDays !== prevEnableOutsideDays || firstDayOfWeek !== prevFirstDayOfWeek) {
      this.setState({
        weeks: (0, _getCalendarMonthWeeks["default"])(month, enableOutsideDays, firstDayOfWeek == null ? localeData.options.weekStartsOn : firstDayOfWeek)
      });
    }
  };
  ...
  _proto.render = function render() {
    ...
    var monthTitle = renderMonthText ? renderMonthText(month) : (0, _format["default"])(month, monthFormat, {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      return /*#__PURE__*/_react["default"].createElement(_CalendarWeek["default"], {
        ...
        return renderCalendarDay({
          ...
          day: day,
          daySize: daySize,
          isOutsideDay: !day || (0, _getMonth["default"])(day) !== (0, _getMonth["default"])(month),
          ...
          phrases: phrases,
          modifiers: modifiers[(0, _toISODateString["default"])(day)] instanceof Set ? modifiers[(0, _toISODateString["default"])(day)] : new Set(),
