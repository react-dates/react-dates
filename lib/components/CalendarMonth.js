...
var _DateObj = _interopRequireDefault(require("../utils/DateObj"));
...
var CalendarMonth = /*#__PURE__*/function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    _this.state = {
      weeks: (0, _getCalendarMonthWeeks["default"])(props.month, props.enableOutsideDays, props.firstDayOfWeek == null ? props.month.localeData().firstDayOfWeek() : props.firstDayOfWeek)
    };
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (!month.isSame(prevMonth) || enableOutsideDays !== prevEnableOutsideDays || firstDayOfWeek !== prevFirstDayOfWeek) {
      this.setState({
        weeks: (0, _getCalendarMonthWeeks["default"])(month, enableOutsideDays, firstDayOfWeek == null ? month.localeData().firstDayOfWeek() : firstDayOfWeek)
      });
    }
  };
