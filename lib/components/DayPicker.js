...
var DayPicker = /*#__PURE__*/function (_ref) {
  ...
  function DayPicker(props) {
    ...
    var currentMonth = props.hidden ? (0, _DateObj.moment)().setLocale(props.locale) : props.initialVisibleMonth();
  ...
  _proto.getFirstDayOfWeek = function getFirstDayOfWeek(locale) {
    ...
    if (firstDayOfWeek == null) {
      firstDayOfWeek = (0, _DateObj.moment)().setLocale(locale).localeData().firstDayOfWeek();
    }
