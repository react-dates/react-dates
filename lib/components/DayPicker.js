...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    }), verticalScrollable && this.renderNavigation()), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooter), _react["default"].createElement("p", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText), {
      onClick: function onClick() {
        return _this6.props.onDatesChange({
          startDate: (0, _moment["default"])().subtract(13, 'days'),
          endDate: (0, _moment["default"])()
        });
      }
    }), "Last 14 days"), _react["default"].createElement("p", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText), {
      onClick: function onClick() {
        return _this6.props.onDatesChange({
          startDate: (0, _moment["default"])().subtract(29, 'days'),
          endDate: (0, _moment["default"])()
        });
      }
    }), "Last 30 days"), _react["default"].createElement("p", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_CalendarFooterText), {
      onClick: function onClick() {
        return _this6.props.onDatesChange({
          startDate: (0, _moment["default"])().subtract(59, 'days'),
          endDate: (0, _moment["default"])()
        });
      }
    }), "Last 60 days")), !verticalScrollable && navPosition === _constants.NAV_POSITION_BOTTOM && this.renderNavigation(), !isTouch && !hideKeyboardShortcutsPanel && _react["default"].createElement(_DayPickerKeyboardShortcuts["default"], {
