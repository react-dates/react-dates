...
var _DateObj = require("../utils/DateObj");
...
var DayPickerSingleDateController = /*#__PURE__*/function (_ref) {
  ...
  function DayPickerSingleDateController(props) {
    ...
    _this.today = (0, _DateObj.moment)().setLocale(locale);
    _this.modifiers = {
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    var today = (0, _DateObj.moment)().setLocale(locale);
  ...
  _proto.UNSAFE_componentWillUpdate = function UNSAFE_componentWillUpdate() {
    var locale = this.props.locale;
    this.today = (0, _DateObj.moment)().setLocale(locale);
  };
  ...
  _proto.isFirstDayOfWeek = function isFirstDayOfWeek(day) {
    ...
    return day.day() === (firstDayOfWeek || _DateObj.moment().localeData().firstDayOfWeek());
  };

  _proto.isLastDayOfWeek = function isLastDayOfWeek(day) {
    var firstDayOfWeek = this.props.firstDayOfWeek;
    return day.day() === ((firstDayOfWeek || _DateObj.moment().localeData().firstDayOfWeek()) + 6) % 7;
  };
