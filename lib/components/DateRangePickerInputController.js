...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  startDate: new _DateObj["default"](),
...
var defaultProps = {
  ...
  isOutsideRange: function isOutsideRange(day) {
    return !(0, _isInclusivelyAfterDay["default"])(day, new _DateObj["default"]());
  },
  isDayBlocked: function isDayBlocked() {
    return false;
  },
  displayFormat: function displayFormat() {
    return new _DateObj["default"]().localeData().longDateFormat('L');
  },
...
var DateRangePickerInputController = /*#__PURE__*/function (_ref) {
  ...
  _proto.onEndDateChange = function onEndDateChange(endDateString) {
    ...
    var endDate = _DateObj["default"].toDateObject(endDateString, this.getDisplayFormat());
  ...
  _proto.onStartDateChange = function onStartDateChange(startDateString) {
    ...
    var startDate = _DateObj["default"].toDateObject(startDateString, this.getDisplayFormat());
