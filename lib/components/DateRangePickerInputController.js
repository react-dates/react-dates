...
function (_ref) {
  ...
  function DateRangePickerInputController(props) {
    ...
    _this.onStartDateTabKeyDown = _this.onStartDateTabKeyDown.bind((0, _assertThisInitialized2["default"])(_this));
  ...
  _proto.onStartDateTabKeyDown = function onStartDateTabKeyDown() {
