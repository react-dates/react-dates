...
var defaultProps = {
  ...
  isOutsideRange: function isOutsideRange(day) {
    return !(0, _isInclusivelyAfterDay["default"])(day, (0, _addHours["default"])((0, _startOfDay["default"])(new Date()), 12));
  },
...
var DateRangePickerInputController = /*#__PURE__*/function (_ref) {
  ...
  _proto.onEndDateChange = function onEndDateChange(endDateString) {
    ...
    if (typeof displayFormat === 'string' && displayFormat !== 'P') {
      endDate = (0, _addHours["default"])((0, _startOfDay["default"])((0, _parse["default"])(endDateString, displayFormat, new Date())), 12);
    } else {
      endDate = (0, _addHours["default"])((0, _startOfDay["default"])((0, _parseISO["default"])(endDateString)), 12);
    }
    ...
    var isEndDateValid = endDate && !isOutsideRange(endDate) && !isDayBlocked(endDate) && !(startDate && (0, _isBeforeDay["default"])(endDate, (0, _addDays["default"])(startDate, minimumNights)));
  ...
  _proto.onStartDateChange = function onStartDateChange(startDateString) {
    ...
    if (typeof displayFormat === 'string' && displayFormat !== 'P') {
      startDate = (0, _addHours["default"])((0, _startOfDay["default"])((0, _parse["default"])(startDateString, displayFormat, new Date())), 12);
    } else {
      startDate = (0, _addHours["default"])((0, _startOfDay["default"])((0, _parseISO["default"])(startDateString)), 12);
    }
    ...
    var isEndDateBeforeStartDate = (0, _isBeforeDay["default"])(endDate, (0, _addDays["default"])(startDate, minimumNights));
  ...
  _proto.getDateString = function getDateString(date) {
    ...
    if (date && displayFormat) {
      (0, _toLocalizedDateString["default"])(date, displayFormat, locale);
    }

    return (0, _toLocalizedDateString["default"])(date, null, locale);
  };
