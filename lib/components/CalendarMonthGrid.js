...
var _isSameMonthAndYear = _interopRequireDefault(require("../utils/isSameMonthAndYear"));
...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)(_objectSpread(_objectSpread({}, _reactWithStyles.withStylesPropTypes), {}, {
  ...
  initialMonth: _propTypes["default"].object,
...
var defaultProps = {
  ...
  initialMonth: (0, _addHours["default"])((0, _startOfDay["default"])(new Date()), 12),
  isAnimating: false,
  numberOfMonths: 1,
  modifiers: {},
...
function getMonths(initialMonth, numberOfMonths, withoutTransitionMonths) {
  ...
  if (!withoutTransitionMonths) month = (0, _subMonths["default"])(month, 1);
  var months = [];
...
var CalendarMonthGrid = /*#__PURE__*/function (_ref) {
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    var hasMonthChanged = !(0, _isSameMonthAndYear["default"])(prevInitialMonth, initialMonth);
    ...
    if (hasMonthChanged && !hasNumberOfMonthsChanged) {
      if ((0, _isNextMonth["default"])(prevInitialMonth, initialMonth)) {
        ...
        newMonths.push((0, _addMonths["default"])(months[months.length - 1], 1));
      } else if ((0, _isPrevMonth["default"])(prevInitialMonth, initialMonth)) {
        newMonths = months.slice(0, months.length - 1);
        newMonths.unshift((0, _subMonths["default"])(months[0], 1));
      } else {
  ...
  _proto.onMonthSelect = function onMonthSelect(currentMonth, newMonthVal) {
    ...
    newMonth = (0, _subMonths["default"])((0, _setMonth["default"])(newMonth, newMonthVal), initialMonthSubtraction);
  ...
  _proto.onYearSelect = function onYearSelect(currentMonth, newYearVal) {
    ...
    newMonth = (0, _subMonths["default"])((0, _setYear["default"])(newMonth, newYearVal), initialMonthSubtraction);
