...
var defaultProps = {
  ...
  initialMonth: new _DateObj["default"](),
  isAnimating: false,
  numberOfMonths: 1,
  modifiers: {},
...
var CalendarMonthGrid = /*#__PURE__*/function (_ref) {
  ...
  function CalendarMonthGrid(props) {
    ...
    _this.setContainerRef = _this.setContainerRef.bind((0, _assertThisInitialized2["default"])(_this)); // TODO check this

    _this.locale = new _DateObj["default"]().localeData();
  ...
  _proto.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    var momentLocale = new _DateObj["default"]().localeData();

    if (this.locale !== momentLocale) {
      this.locale = momentLocale;
      newMonths = newMonths.map(function (m) {
        return m.setLocale(_this2.locale);
      });
    }
